...
PhysBody* ModulePhysics::CreatePolygonSensor(int x, int y, int size, b2Vec2* vec, PhysBody_Type sensor_type)
{
	b2BodyDef bodyDef;
	...
	sensorShape.Set(vec, size);

	b2FixtureDef fixture;
	fixture.shape = &sensorShape;
	fixture.density = 1;
	fixture.isSensor = true;
